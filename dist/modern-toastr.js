...
/******/ 	}
/******/ 	var parentHotUpdateCallback = this["webpackHotUpdateToastr"];
/******/ 	this["webpackHotUpdateToastr"] = 
...
var ToastrConteiner = function () {
  function ToastrConteiner(type, message, title, config) {
    _classCallCheck(this, ToastrConteiner);

    this.type = type || 'success';
    this.message = message;
    this.title = title;
    this.config = _extends({}, ToastrProps.config, config);
  ...
  _createClass(ToastrConteiner, [{
    key: 'display',
    value: function display() {
      var timeOut = this.config.timeOut;
      var classType = this.type || 'success';
      var divTitle = this.title ? '<div class="toastr-title">' + this.title + '</div>' : '';
      var divMessage = this.message ? '<div class="toastr-message">' + this.message + '</div>' : '';
      var divClose = this.config.closeButton === true ? ToastrProps.closeHtml : '';
  ...
  return ToastrConteiner;
}();

var Toastr = {
  setDefaultConfig: function setDefaultConfig(options) {
    ToastrProps.config = _extends({}, ToastrProps.config, options);
  },
  ...
  warn: function warn(message, title, options) {
